    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[400px] flex items-center justify-center bg-[#F0FDF4] overflow-hidden mb-12">
        <img
          ...
          alt="Justus Chicks Hero"
        //   blur
          className="absolute inset-0 w-full h-full object-cover object-bottom  z-0"
        />
        {/* dark overlay */}
        <div className="absolute  bg-black z-50" > zxzz</div>
        {/* Text content */}
        
        
        <div className="relative z-20 text-center px-4">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-[#00743F] drop-shadow mb-4">About Justus Chicks</h1>
          <p className="text-lg sm:text-2xl text-[#104269] font-medium max-w-2xl mx-auto drop-shadow">
      ...
      <section className="max-w-5xl mx-auto mb-16 px-4">
        <h2 className="text-2xl font-bold text-[#00743F] mb-6 text-center">Why Choose Justus Chicks?</h2>
